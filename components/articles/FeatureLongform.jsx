...
//       style={{ border: `1px solid ${RULE}`, backgroundColor: "#FFFFFF" }}
//     >
...
//       </div>
//       <div className="p-2.5">
//         <h3 className="font-serif text-[12.5px] font-bold leading-snug text-[#16181D] break-words line-clamp-3 group-hover:opacity-70 transition-opacity">
//           {article.headline}
//         </h3>
//       </div>
//     </Link>
...
// function RelatedClientPosts({ posts, clientName }) {
//   if (!posts || posts.length === 0) return null;
//   return (
//     <div className="mt-16 pt-12" style={{ borderTop: `1px solid ${RULE}` }}>
//       <Eyebrow>{clientName ? `More on ${clientName}` : "Related Coverage"}</Eyebrow>
//       <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
//         {posts.map((post) => (
//           <RelatedClientCard key={post.slug} article={post} />
//         ))}
//       </div>
//     </div>
//   );
...
//   article,
//   related, // generic same-category posts; kept for API compatibility, not rendered
//   clientRelated, // posts about this same client only — rendered below
//   categoryLabel,
//   absoluteUrl,
// }) {
...
//         {/* Full-width, below the two-column section so it sits under both
//             the body copy and the (now-stopped) sticky sidebar. */}
//         <RelatedClientPosts posts={clientRelated} clientName={article.client} />
//       </div>
//     </article>
//   );
// }
