  ...
  return (
    <div className="mt-10 flex gap-5 rounded-lg border border-[#594f4f] p-6">
      ...
      <div className="min-w-0">
        ...
        {authorRole && <p className="font-sans text-xs text-[#8A8A8A] mb-2">{authorRole}</p>}
        {authorBio && (
          <p className="font-sans text-sm leading-relaxed text-[#595959] break-words">{authorBio}</p>
        )}
        {authorSocial && (
...
export default function ArticleDetail({ article, related, categoryLabel, absoluteUrl }) {
